...
def _is_file_node(G: nx.Graph, node_id: str) -> bool:
    ...
    if source_file:
        from delegation_core.graph.build import _is_file_node_label
...
from delegation_core.graph.detect import CODE_EXTENSIONS, DOC_EXTENSIONS, PAPER_EXTENSIONS, IMAGE_EXTENSIONS
