...
def _semantic_id_remap(nodes: list, root: str | None) -> dict:
    ...
    from delegation_core.graph.extractors.base import _file_stem  # local: avoid import cost at module load
...
def graph_has_legacy_ids(nodes: list, root: str | Path | None = None, sample: int = 300) -> bool:
    ...
    from delegation_core.graph.extractors.base import _file_stem
...
def build_from_json(extraction: dict, *, directed: bool = False, root: str | Path | None = None) -> nx.Graph:
    ...
    from delegation_core.graph.extractors.base import _file_stem as _fs
...
def build(
    ...
    *,
    ...
    """
    from delegation_core.graph.dedup import deduplicate_entities
    ...
    *,
    ...
    if existing_hyperedges:
        ...
        for he in existing_hyperedges:
            ...
            carried.append(he)
        if carried:
            from delegation_core.graph.export import attach_hyperedges
