...
from delegation_core.graph.ids import make_id as _shared_make_id
...
# only delegation_core.graph.ids), so this can no longer drift from extract._file_stem.
from delegation_core.graph.extractors.base import _file_stem  # noqa: E402
